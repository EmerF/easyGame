...
public class RepositorioCarro {
	...
	public long inserir(Carro carro) {
		...
		values.put(Carro.Carros.NOME, carro.nome);
		values.put(Carro.Carros.PLACA, carro.placa);
		values.put(Carro.Carros.ANO, carro.ano);
	...
	public Carro buscarCarro(long id) {
		...
		Cursor c = db.query(true, NOME_TABELA, Carro.colunas, Carro.Carros._ID + "=" + id, null, null, null, null, null);
	...
	public Carro buscarCarroPorNome(String nome) {
		...
		try {
			...
			Cursor c = db.query(NOME_TABELA, Carro.colunas, Carro.Carros.NOME + "='" + nome + "'", null, null, null, null);
